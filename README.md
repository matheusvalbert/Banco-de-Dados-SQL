...
Além da criação das tabelas, foram criadas funções em PLSQL para facilitar o manuseio do banco de dados, impedindo que alunos que não se encaixem nos pré-requisitos não possam ser inscritos em determinadas matérias além de funções de consulta no banco.
```
